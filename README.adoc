...
. 加解密操作，Base64、MD5/BCrypt/AES/SHA等对称算法和RSA等非对称算法
...
// 数组 转 Base64
base64 = $.encrypt.encodeBytesToBase64("gudaoxuri".getBytes());
// Base64 转 字符串
String str = $.encrypt.decodeBase64ToString(base64, "UTF-8");
// Base64 转 字符串
byte[] bytes = $.encrypt.decodeBase64ToBytes(base64);

// 对称加密（此处使用SHA-256算法，支持如bcrypt SHA-256 MD5 AES等算法）
...
String encrypt = $.encrypt.Symmetric.encrypt("gudaoxuri", "pwd", "AES");
// 对称解密（此处使用AES算法，需要提供密码）, BadPaddingException 异常表示密码错误
$.encrypt.Symmetric.decrypt(encrypt, "pwd", "AES");
...
<!--$.bean dependency end-->
<!--$.encrypt dependency begin-->
<exclusion>
    <groupId>org.mindrot</groupId>
    <artifactId>jbcrypt</artifactId>
</exclusion>
<!--$.encrypt dependency end-->
